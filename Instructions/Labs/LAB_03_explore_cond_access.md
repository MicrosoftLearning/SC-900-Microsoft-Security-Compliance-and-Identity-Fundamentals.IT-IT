<!---
---
Lab: percorso di apprendimento: "Descrivere le funzionalità di Microsoft Entra", Modulo: "Descrivere le funzionalità di gestione degli accessi di Microsoft Entra ID", Unità: "Descrivere l'accesso condizionale"
---
--->
...
1. Verrà visualizzata una finestra con l'indicazione Sono necessarie altre informazioni.  Seleziona **Avanti**.  Notare che in questo modo si avvierà il processo di registrazione MFA, poiché si tratta del primo accesso all'app cloud identificata nei criteri di accesso condizionale.  Questa procedura di registrazione viene richiesta una sola volta.   Un'alternativa al processo di registrazione dell'utente è quella di far configurare all'amministratore il metodo di autenticazione da utilizzare.
