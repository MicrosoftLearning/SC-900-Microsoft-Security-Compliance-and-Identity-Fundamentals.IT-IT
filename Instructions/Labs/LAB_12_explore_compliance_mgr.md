...
# Laboratorio: Esplorare il portale di conformità di Microsoft Purview e Compliance Manager
...
1. Uscire da questa azione di miglioramento selezionando **Azioni di miglioramento** nella barra di navigazione in alto a sinistra della pagina.  Ora si è di nuovo nella pagina delle azioni di miglioramento.
...
1. Nella parte superiore sinistra della pagina, sopra dove si dice Valutazioni (percorso), selezionare **Valutazioni** per tornare alla pagina delle valutazioni.  Prima di uscire dalla scheda valutazioni, tieni presente che puoi aggiungere valutazioni personalizzate.

1. Nella parte superiore della pagina selezionare **Normative**.  Questa pagina elenca le normative disponibili per l'organizzazione. È anche possibile creare valutazioni dai modelli disponibili.  Selezionare uno dei modelli Premium dall'elenco.  Verranno visualizzate informazioni specifiche su tale regolamento, inclusi i controlli, le azioni di miglioramento e l'azione Microsoft.  Nell'angolo superiore destro della finestra selezionare i **puntini di sospensione** per visualizzare l'opzione **+ Crea valutazione**, che consente di creare una valutazione basata sul modello.  Tornare alla pagina delle normative selezionando **Regolamenti** nella parte superiore della pagina.

1. Nella parte superiore della pagina selezionare **Avvisi**.   Qui è possibile visualizzare e gestire gli avvisi per gli eventi che possono influire sul punteggio di conformità dell'organizzazione.  Se è presente un avviso elencato, selezionarlo per visualizzare le informazioni sui criteri di avviso associati.
